...
Lorsqu’on déclare une variable, il ne suffit pas de créer une boîte (réserver un emplacement mémoire en informatique) ; encore doit-on préciser ce que l’on voudra mettre dedans, car de cela dépendent la  taille  de la boîte (de l’emplacement mémoire) et le  type de codage  utilisé.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQxODY2NzU1MywtMjA0NjQ1OTQxNCwtMT
E3NDYzNTYyNV19
-->