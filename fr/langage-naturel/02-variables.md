...
Lorsqu’on déclare une variable, il faut aussi indiquer le type de do ce que l’on voudra mettre dedans, car de cela dépendent la  taille  de la boîte (de l’emplacement mémoire) et le  type de codage  utilisé.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwOTI4MDA0MzQsMTQxODY2NzU1MywtMj
