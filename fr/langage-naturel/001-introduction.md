...
- **Remarque** :
	...
	- Dans un **test imbriqué**, on regroupé **Sinon** et **Si** en **SinonSi** pour devenir un seul bloc de test, conclu par un seul FinSi
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTczMzcyMjYwMiwxODUwOTI1MDAzLC0zMz
