...
- **Remarque** :
	...
	- Dans les tests imbriqués, le Sinon et le Si peuvent être transformé en **SinonSi**; il s’agit d’un seul bloc de test, conclu par un seul FinSi
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTcyMzg1NzQxLDE4NTA5MjUwMDMsLTMzMT
